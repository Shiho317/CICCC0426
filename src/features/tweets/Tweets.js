...
import { Flex, Input, IconButton, Wrap, WrapItem, Stack, Skeleton, Alert, AlertIcon, AlertDescription, AlertTitle, CloseButton } from "@chakra-ui/react";
...
const Tweets = () => {
  ...
  const { isLoading, error, tweets } = useSelector((state) => state.tweets)
